			...
			>
				<div class="space-y-1">
					<For each={filteredWords()}>
						{(word) => (
							<div class="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-(--flexoki-bg-2) border border-(--flexoki-ui-2) group">
								<Show
									...
									fallback={
										<>
											...
											<button
												...
												class="opacity-0 group-hover:opacity-100 transition-opacity p-0.5 hover:bg-(--flexoki-ui-3) rounded"
								...
								>
									<input
										...
										class="flex-1 text-sm bg-transparent outline-none text-(--flexoki-tx) focus:ring-1 focus:ring-(--flexoki-cyan) rounded px-1"
										autofocus
									/>
									<button
										onClick={() => handleEditSave(word)}
										class="p-0.5 hover:bg-(--flexoki-ui-3) rounded"
										aria-label="Save"
									>
