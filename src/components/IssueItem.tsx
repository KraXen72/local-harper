...
const IssueItem: Component<IssueItemProps> = (props) => {
	...
	const handleClick = () => {
		...
		// Also focus the issue in the editor via centralized manager (no-op if editor not attached)
		void editorManager.focusIssue(props.issue.id).catch?.(console.error);
	};
