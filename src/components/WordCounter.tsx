    ...
    return (
        <div class="pt-1 pb-3 px-2 text-sm text-(--flexoki-text-muted)">
            <div class="flex items-center justify-between">
                ...
                {/* mobile wordcount */}
                <div class="sm:hidden text-sm" aria-hidden="false">Ch: {counts().graphemes} &middot; Sent: {counts().sentences} &middot; Ln: {counts().lines} &middot; Par: {counts().paragraphs}</div>
                {/* md/lg+ wordcount */}
